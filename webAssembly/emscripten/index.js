...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '/var/www/html/aprendiendoC/webAssembly/emscripten/index.data';
  ...
  Module['FS_createPath']('/', 'tests', true, true);
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_/var/www/html/aprendiendoC/webAssembly/emscripten/index.data');

      };
      Module['addRunDependency']('datafile_/var/www/html/aprendiendoC/webAssembly/emscripten/index.data');
   ...
   loadPackage({"files": [{"filename": "/tests/hello_world_file.txt", "start": 0, "end": 199, "audio": 0}], "remote_package_size": 199, "package_uuid": "d9f7cb2a-43b8-40c9-9560-853a00f23f29"});
